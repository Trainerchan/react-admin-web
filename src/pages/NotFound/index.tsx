...
export default function NotFound() {
  useEffect(()=>{
    document.title = '错误 - 404'
  },[])
  return (
    <div className={`${styles['not-found']} container mx-auto flex h-full w-full items-center`}>
      <div className="container flex flex-col items-center justify-center px-5 text-gray-700 md:flex-row">
        <div className="max-w-md">
          ...
          <Link
            to="/"
            className="focus:shadow-outline-blue inline rounded-lg border border-transparent bg-slate-300 px-4 py-2 text-sm font-medium leading-5 text-slate-900 shadow transition-colors duration-150 focus:outline-none"
          >
            back to homepage
          </Link>
        </div>
